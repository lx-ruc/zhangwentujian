...
/** 违禁词黑名单：报告任何字段命中即拒绝（触发重试/兜底/draw 拒收） */
export const BANNED_TERMS = [
  // 运系（2026-09 全量禁止；现名「AI掌纹分析」亦不含"运"。品牌名仅出现在展示层，报告内容零例外）
  '运势', '运气', '好运', '转运', '转好运', '旺', '桃花劫', '破财', '招财',
  // 手掌系（拒审整改：拍摄/报告/分享任何可见面不得出现；单字「掌」一网打尽）
  '掌', '手掌', '掌纹', '掌心', '巴掌', '手纹',
  // 命系
...
export const GENERIC_SCENES: ReportShape['scenes'] = {
  work: {
    traits: [
      '节奏整体平缓清晰：做事倾向先看清全局再动手，是"谋定后动"型。',
